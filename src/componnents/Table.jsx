  ...
  return (
    <tr key={i}>
      ...
      <td className={`${Text}  float-right flex flex-row justify-center items-center gap-2`}>
        {admin ? (
          <>
            <button className="border border-border bg-dry flex flex-row justify-center items-center gap-2 text-border rounded py-1 px-2">
              Edit <FaEdit className="text-green-500" />
            </button>
            <button className="bg-subMain text-white rounded flex flex-col justify-center items-center w-6 h-6">
              <MdDelete />
            </button>
          </>
        ) : (
          <>
            ...
            <Link
              to={`/movie/${movie?.name}`}
              className="bg-subMain text-white rounded flex flex-row justify-center items-center w-6 h-6"
            >
              <GoEye />
            </Link>
          </>
